...
El código utilizado para hacer este mapa está acualizado al martes, 24 de marzo de 2020. Si no encuentras disponible la última actualización, por favor escríbenos a info@elquantificador.com. Muchas gracias.
...
url <- "https://github.com/aquijanoruiz/elquantificador_posts/raw/master/salud/2020-03-22-mapa-del-coronavirus-en-el-ecuador/provincias.zip"
...
url <- "https://github.com/aquijanoruiz/elquantificador_posts/raw/master/salud/2020-03-22-mapa-del-coronavirus-en-el-ecuador/cantones.zip"
td <- tempdir() # We create a temporary directory
tf <- tempfile(tmpdir=td, fileext = ".zip") # We create the placeholder file
download.file(url,tf) # We download the data into the placeholder file
